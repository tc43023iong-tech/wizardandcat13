...
export const USEFUL_SENTENCES_QUIZ: QuizQuestion[] = [
  {
    question: "You see a big group of animal friends laughing (大笑) and talking in the school hallway (走廊). You want to ask what is happening (發生什麼事). You say:",
    options: ["I need your help.", "What's going on?", "Come with me!"],
    answer: "What's going on?",
    image: "/assets/images/quiz_img_1_1781343661578.jpg"
  },
  {
    question: "You are sitting at your desk and cannot solve (無法解答) a very difficult math question. You want to ask for help. You say:",
    options: ["What's going on?", "Come with me?", "I need your help."],
    answer: "I need your help.",
    image: "/assets/images/quiz_img_2_1781343680990.jpg"
  },
  {
    question: "You found a beautiful butterfly (蝴蝶) in the garden (花園)! You want your best friend to follow (跟隨) you to see it. You say:",
    options: ["Come with me!", "I need your help.", "What's going on?"],
    answer: "Come with me!",
    image: "/assets/images/quiz_img_3_1781343695777.jpg"
  },
  {
    question: "Your schoolbag (書包) is too heavy (太重了) and you cannot carry (提) it by yourself (自己). You want a helper (幫手) to assist (協助) you. You say:",
    options: ["Come with me!", "I need your help.", "What's going on?"],
    answer: "I need your help.",
